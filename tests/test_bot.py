...
from bot import start, help_command, status, lights, light_on, light_off, switches, sensors
...
class TestTelegramBot:
    ...
    @pytest.mark.asyncio
    @patch('bot.ha_client')
    async def test_status_command_success(self, mock_ha_client, mock_update, mock_context):
    ...
    @pytest.mark.asyncio
    @patch('bot.ha_client')
    async def test_status_command_failure(self, mock_ha_client, mock_update, mock_context):
    ...
    @pytest.mark.asyncio
    @patch('bot.ha_client')
    async def test_light_on_command_success(self, mock_ha_client, mock_update, mock_context):
    ...
    @pytest.mark.asyncio
    @patch('bot.ha_client')
    async def test_light_off_command_success(self, mock_ha_client, mock_update, mock_context):
