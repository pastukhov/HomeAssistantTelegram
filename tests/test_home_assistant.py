...
class TestHomeAssistantAPI:
    ...
    def test_call_service_success(self, mock_make_request):
        ...
        mock_make_request.assert_called_once_with("POST", "/api/services/light/turn_on", expected_data)
    ...
    def test_get_lights(self, mock_get_states):
        ...
        mock_get_states.return_value = [
            ...
            {"entity_id": "switch.fan", "state": "off", "attributes": {"friendly_name": "Fan Switch"}},
    ...
    def test_get_switches(self, mock_get_states):
        ...
        mock_get_states.return_value = [
            {"entity_id": "light.bedroom", "state": "on", "attributes": {"friendly_name": "Bedroom Light"}},
            {"entity_id": "switch.fan", "state": "off", "attributes": {"friendly_name": "Fan Switch"}},
            {"entity_id": "switch.pump", "state": "on", "attributes": {"friendly_name": "Water Pump"}}
        ]
